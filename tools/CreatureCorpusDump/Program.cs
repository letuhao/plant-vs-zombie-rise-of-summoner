...
//   dotnet run --project tools/CreatureCorpusDump -- <server data dir> --check      (owner, local, real DB)
//   dotnet run --project tools/CreatureCorpusDump -- --verify <dump root>           (CI — no DB needed)
