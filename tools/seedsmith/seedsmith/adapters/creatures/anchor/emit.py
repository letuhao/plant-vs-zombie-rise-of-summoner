"""`anchor-emit` (creature-seed module 8, spec-anchor-emit.md) — writes classified anchors to
`data/seed/creatures/species/**.json` as seed files (item/seed-contract.md's law): the seed is
