"""The species anchor schema (creature-seed module 2, spec-anchor-contract.md). Twenty-one keys for
...
#   DEPLOY_MODE   src/FusionRpg.Core/Creatures/CreatureRarity.cs (enum CreatureDeployMode)
#   ACQUISITION   src/FusionRpg.Core/Creatures/CreatureRarity.cs (enum CreatureAcquisition, [Flags])
#   RARITY        docs/architecture/item/ssot-rarity.md §3.3 (ten-rung ladder, creatures adopted 2026-09-01)
#   THREAT_BAND   data/tuning/creature-threat.v1.json (creature-seed module 4)
