"""`fusion-recipe-propose`'s own per-member majority over a proposed PAIR (demon-seed module 17,
...
def assign_input_a_b(
    ...
    """The exact assignment `DemonRecipeCatalog.TryFindPair` already uses for every other recipe
    ...
    wins `inputA`. A/B carries no gameplay asymmetry either way (`spec-demon-fusion.md` lock 5's
