"""The bounded, deficit-only `fusion-recipe-propose` prompt (demon-seed module 17,
...
class FusionCandidate:
    ...
    does not count as a step (the same walk `DemonRecipeCatalog.InputPoolBelow` already performs).
    """
    species_id: str
    element_primary: str
    rarity: str
...
SYSTEM_PROMPT = (
    "You propose a fusion recipe for ONE demon species that the deterministic pairing pass could "
