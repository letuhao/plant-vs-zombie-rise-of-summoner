> ⛔ **SUPERSEDED 2026-09-06.** This module (RB6) targeted the creature-species roster on a
...
current try to load almanac or creature seed first without a distribution plan and it cause current
problem."*
