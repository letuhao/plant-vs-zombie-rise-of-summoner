> ⛔ **SUPERSEDED 2026-09-06.** This module (RB2) targeted the creature-species roster on a
...
**What would overturn it:** a `creature-seed` decision that a secondary element should be common.
