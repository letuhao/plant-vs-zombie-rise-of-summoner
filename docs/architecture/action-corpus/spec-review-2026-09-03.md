...
2. **A-S5** cited `report/cli.py:728-741` as *"the runner and its `--gate`/`--json` surface"*. That
   range is `_cmd_creatures_diff_legacy`. The runner is `cmd_report` at `:154`; the flags are at
   `:778-780` and `:793-795`.
