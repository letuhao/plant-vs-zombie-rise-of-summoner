...
- [ ] Bound lawn UniqueCreature parity + Bound loadout via Hub. **Split (corrected 2026-09-15 audit):** UniqueCreature parity is done — live-proven 2026-09-14 in both trigger orders after `aptitude-sheet` AS-1.1b (T12). Bound loadout via Hub (T14) is Core-proven only; its live probe is still owed (2026-09-15 Mode B: persisted half OK, live read timed out, equip step never ran).
