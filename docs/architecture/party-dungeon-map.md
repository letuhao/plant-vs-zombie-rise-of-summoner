...
**Plan / tasks (written 2026-09-05):** `tasks/party-dungeon-plan.md` · `tasks/party-dungeon-todo.md` — the
prefixed pair this repo's parallel-program convention requires (see [CONTRIBUTING.md](../../CONTRIBUTING.md));
the bare pair is another stream's and is never a fallback.
