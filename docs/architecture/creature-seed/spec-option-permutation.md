...
**Module id:** `option-permutation` · **Program:** [creature-seed](../creature-seed-map.md) · **Build order:** 6 of 16
...
```powershell
python -m seedsmith creatures permute --species <id> --field elementPrimary   # show the three orders
python -m seedsmith creatures vote-report                                     # disagreement rate per field
...
```text
tools/seedsmith/seedsmith/adapters/creatures/anchor/permute.py   seeding + ordering
tools/seedsmith/seedsmith/adapters/creatures/anchor/vote.py      resolution + confidence
