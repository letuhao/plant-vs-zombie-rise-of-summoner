...
**Module id:** `threat-band` · **Program:** [creature-seed](../creature-seed-map.md) · **Build order:** 4 of 16
**Model calls:** none.
...
`data/tuning/creature-threat.v1.json`:
...
```powershell
python -m seedsmith creatures threat-band --dump data/seed/creatures/_dump
python -m seedsmith creatures threat-band --histogram        # rung occupancy, the balance-pass view
...
```text
tools/seedsmith/seedsmith/adapters/creatures/power/bands.py    table load + lookup, no literals
data/tuning/creature-threat.v1.json                            the balance surface
