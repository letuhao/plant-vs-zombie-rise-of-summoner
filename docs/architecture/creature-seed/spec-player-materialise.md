...
**Module id:** `player-materialise` · **Program:** [creature-seed](../creature-seed-map.md) · **Build order:** 16 of 16
...
`WaveCatalog`, `CreatureRecipeCatalog`, `CreatureMaterialCatalog` and `LaneCost` keep reading the **shared**
...
```text
src/FusionRpg.Core/Creatures/Materialise/SpeciesMaterialiser.cs   the derivation, pure and testable
...
tests/FusionRpg.Core.Tests/Creatures/MaterialiseTests.cs
