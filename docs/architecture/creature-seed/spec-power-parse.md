...
**Module id:** `power-parse` · **Program:** [creature-seed](../creature-seed-map.md) · **Build order:** 3 of 16
...
Run against the committed 84-species corpus (`data/seed/creatures/creature/**`), 2026-09-01:
...
`python -m seedsmith creatures power-parse --dump data/seed/creatures/_dump --report`, run against the real
...
```powershell
python -m seedsmith creatures power-parse --dump data/seed/creatures/_dump
python -m seedsmith creatures power-parse --dump ... --report   # basis histogram, disagreement list
...
```text
tools/seedsmith/seedsmith/adapters/creatures/power/parse.py     the patterns and precedence
tools/seedsmith/seedsmith/adapters/creatures/power/model.py     PowerSeed dataclass, frozen
