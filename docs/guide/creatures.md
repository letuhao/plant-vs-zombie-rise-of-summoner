...
Open a specimen for the full panel: overview, progression, actions, passives, and gear. Today the roster already shows level, gear, and history; the finished sheet is the place every tab lives together, including locked skill previews before you unlock them.

---

## Souls and essence

**Souls** are the player stock you earn from play and spend at the altar, on pacts, and on rituals. They bank across worlds.

**Essence** is element-matched material for fusion (and later some buildings). You cannot always swap one colour for another — that tension is the point. Essence also banks across worlds.

Together with **loam** on the map, those are the three stocks of the war. See [The rift](the-rift.md).
...
Merge specimens into stronger forms:

- **Star merges** preserve identity and push power
- **Recipes** you discover by experimenting, not by reading a wiki first
- **Trait inheritance** so fusion creates builds, not only bigger numbers
- **Promotion** raises rarity once, with a cost

Fusion materials (**essence**) come from play and expeditions.
...
- Onto the **rift** as part of a legion (**WIP** as the map→battle handoff hardens)

A specimen on an expedition is soft-locked from lawn deploy and the reverse — no double-dipping.
