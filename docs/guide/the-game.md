...
**Status:** concept — the fiction holds whether a surface is Shipped, WIP, or Vision.

This page and [The loops](the-loops.md) are the **product vision** for Rise of Summoner. Every feature in this guide hangs on that vision.
...
| | |
|---|---|
| **Win** | Find Zomboss’s fortress sector and take it |
| **Lose** | The homeworld falls |

**You keep who you are. You lose where you were.**

Roster, souls, and essence bank across worlds. Loam and the holdings of a failed map do not. Ending one world and starting another *is* the progression loop — not a soft reset of your summoner.
...
Same roster. Same souls. Same world. Whichever place you are playing from.

The full list of loops — spine and places — lives on [The loops](the-loops.md). That page is what later features must extend.
...
Every page in this guide is a piece of that.
...
- You are not running a cloud MMO. Play is local, on your machine, with no account.
- You are not patching the game binary. The lawn game stays a legal Plants vs. Zombies install you point the launcher at.
- You are not limited to three stocks. You have exactly three: **souls**, **essence**, and **loam** (loam never banks). There is no stamina gate and no fourth wallet.

Next: [How you play](how-you-play.md) · [The loops](the-loops.md).
