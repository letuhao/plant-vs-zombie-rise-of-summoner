...
**Status:** Shipped  
**Loop:** Idle expeditions · Summon and fusion — see [The loops](../the-loops.md)  
**Pillar:** [Expeditions](../expeditions.md)  
**HTML guide:** [site/mechanisms/expeditions.html](../site/mechanisms/expeditions.html)
...
- Expeditions are a sibling of the Delve, not a prototype to replace. Auto-resolve stays; interactive battles you play yourself are WIP elsewhere.
- Quest- and world-event-starting ticks stay Vision — see [expedition event ticks](expedition-event-ticks.md).
...
> Stop when dispatch → wait → collect is clear. Next: [slots and recall](expedition-slots-recall.md).

---

## Common mix-ups

**Do I need the lawn game open?**  
No. Once unlocked, expeditions run from the control room with the lawn closed.

**Is this a delve?**  
No. Delves are a separate Vision stage. Expeditions stay the async idle loop.

**Is there a stamina cost?**  
No. There is no stamina gate on expeditions.

**Do rewards expire if I forget to collect?**  
No. Collect when you are ready.

**Can expeditions start quests today?**  
Full quest and world-event ticks are Vision — see [expedition event ticks](expedition-event-ticks.md).

---

## Related

- Next: [Expedition slots and recall](expedition-slots-recall.md)
- [Expedition slots and recall](expedition-slots-recall.md)
- [Wild joins](wild-joins.md)
- [Essence](essence.md)
- [Expedition quest and event ticks](expedition-event-ticks.md)
- Pillar: [Expeditions](../expeditions.md)
