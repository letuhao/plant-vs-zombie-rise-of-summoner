...
**HTML guide:** [site/mechanisms/lawn-deploy.html](../site/mechanisms/lawn-deploy.html)
...
- They fight with the traits and element you gave them — combat language still applies.
- Specimens themselves: [specimens](specimens.md).
...
Bind first, then field when free:

```text
  pact-bound specimen  ->  (not on expedition?)  ->  deploy into lawn match
                         plant avatar  or  hypno-zombie ally (designated)
```
...
> If a name is greyed or blocked, check expeditions before assuming a bug.

---

## What you do (first time)

1. Confirm at least one specimen is bound on a pact.
2. Make sure it is not out on an expedition.
3. During a match, deploy it and watch it appear on the mirror.

> Parent loop: [lawn match](lawn-match.md). Soft-locks also protect expedition integrity — see [expeditions](expeditions.md).
...
- Next: [Lawn blessing](lawn-blessing.md)
