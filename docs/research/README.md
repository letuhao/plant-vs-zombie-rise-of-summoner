...
| **FE Phaser architecture** | [phaser-architecture-prior-art-2026-09-06.md](phaser-architecture-prior-art-2026-09-06.md) — multi-mode reuse (scenes, plugins, assets, VFX/SFX, camera, dataflow); reconcile with [../architecture/fe-phaser-architecture-audit.md](../architecture/fe-phaser-architecture-audit.md) |
