...
| **FE Phaser architecture** | [phaser-architecture-prior-art-2026-09-06.md](phaser-architecture-prior-art-2026-09-06.md) — multi-mode reuse; reconcile with [../architecture/fe-phaser-architecture-audit.md](../architecture/fe-phaser-architecture-audit.md) · [phaser-scene-switch-poc-2026-09-06.md](phaser-scene-switch-poc-2026-09-06.md) — Track A/B POC (locks cleared) · program specs: [../architecture/phaser-kernel-map.md](../architecture/phaser-kernel-map.md) + [../architecture/phaser-kernel/](../architecture/phaser-kernel/) |
