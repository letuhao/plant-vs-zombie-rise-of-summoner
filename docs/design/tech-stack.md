...
| **G6** | **Coverage configuration** | Scope is 9.3% of the FE and the *game* modules (`world`, `creatures`, `expeditions`, `fusion`, `patron`) sit at **0%** | Rewrite the include list around the new structure; per-area thresholds |
