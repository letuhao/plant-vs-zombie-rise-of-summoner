...
| [architecture/effect-atom-map.md](architecture/effect-atom-map.md) | **Capability map** — atom effects as the Secondary SSOT: 20 modules in 5 waves, dependency order, checkpoints, four cross-program hazards. **All 21 rows built, Checkpoints A–E reached, no golden re-blessed — Checkpoint F (wave 6, E20–E25) is planned to close the completeness-audit gap: most of it is not yet joined to the running game** |
