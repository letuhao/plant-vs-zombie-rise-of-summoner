...
| [architecture/gui-lego-map.md](architecture/gui-lego-map.md) | **Capability map (design-only)** — game menu Lego kit: pieces, themes, recipes; first surface Derived combat console. Ideal [gui-lego-ideal.md](architecture/gui-lego-ideal.md); drafts [design/gui-lego/](design/gui-lego/) |
