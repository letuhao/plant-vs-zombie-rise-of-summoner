...
- [ ] LIVE lab board eyeball (quick-start) — optional owner polish
...
- [x] Spec approved
- [ ] Shield row parity verified vs old ShieldBarPool (LIVE — optional owner polish)
...
- [ ] LIVE: no double shield bar; sustain VFX intact — optional owner polish
