...
- [ ] **Task 1: GameEventRec struct + kind enum + interning**
...
- [ ] **Task 2: Counter/stack math takes HitCount**
...
- [ ] **Task 3: Chance proc closed-form merge**
...
### Checkpoint 1
- [ ] All new Phase-1 tests green; all 733 existing Core tests green untouched; guards green.

## Phase 2: Ring + coalescer (pure Core)

- [ ] **Task 4: GameEventRing**
...
### Checkpoint 2
- [ ] Ring + coalescer tests green; all suites green.

## Phase 3: Drain (pure Core)

- [ ] **Task 6: EventDrain core — budgeted FIFO**
...
- [ ] **Task 7: Barriers, chain records, session bypass**
...
### Checkpoint 3
- [ ] Spec test groups 1–6 all green; 733 + new tests green; guards green.
...
- [ ] **Task 10: Drain host + death flush + transport**
...
- [ ] **Task 11: FPS cap default + probe counters**
...
### Checkpoint 4
- [ ] Injector builds vs game dir; 4 guards green; all 5 test suites green.
