...
have seen.** The `CreatureSpeciesCatalog` local-dev-data gap named above was fixed directly (`dotnet run
--project tools/CreatureSpeciesImport -- --db src/FusionRpg.Server/data`, a safe, isolated dev database
...
`CreaturesPage` volume defect the Codex route hangs off, auto-drafting a species starter plan, shareable
