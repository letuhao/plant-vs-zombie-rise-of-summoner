...
- **Dependencies:** None.
- **Files likely touched:** `src/FusionRpg.Core/Creatures/`, `src/FusionRpg.Contracts/`,
...
- **Acceptance:**
  - [ ] A unique sharing a species with a general creature has no species allocation contribution.
...
- **Files likely touched:** `src/FusionRpg.Server/UniqueActorHubCompose.cs`,
  `src/FusionRpg.Server/WebMatchService.cs`, `src/FusionRpg.Core/Stats/Aptitudes/UniqueCreatureAllocation.cs`,
...
- **Acceptance:**
  ...
  - [ ] General-creature behavior remains unchanged under valid `EmpireGeneral` provenance.
