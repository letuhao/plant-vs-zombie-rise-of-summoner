...
/// from a committed <c>data/generated/creatures/&lt;SpeciesId&gt;.json</c> file straight to a
...
public static class ConcreteSpeciesMapper
{
    public static CreatureSpeciesDef ToCreatureSpeciesDef(ConcreteSpecies s) => new()
    {
        ...
        // CreatureSpeciesGenerator.cs already established, reproduced here rather than invented anew.
        CreatureTypeId = CreatureSpeciesCatalog.CreatureTypeIdFloor + (s.Side == "plant" ? 50_000 : 0) + s.GameTypeId,
