...
/// (`tools/seedsmith/seedsmith/adapters/creatures/anchor/`), read back into C# for `species-generator`
...
/// `data/seed/creatures/species/`) found zero missing, against six real values (`frontline 221 ·
...
/// array of anchor objects, `data/seed/creatures/species/**.json`).</summary>
